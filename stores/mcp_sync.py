...
DEFAULT_FILES = [
    ...
    '/media/mass/scripts/twin/stores/ha_entities.txt',
]
...
def main():
    ...
    parser.add_argument('--output-dir', default="/media/mass/scripts/twin/stores", help="Directory to save output files (default: /media/mass/scripts/twin/stores)")
