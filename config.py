...
WAKE_SOUND_FILE = os.getenv('WAKE_SOUND_FILE', '/media/mass/scripts/twin/wake.wav')
SLEEP_SOUND_FILE = os.getenv('SLEEP_SOUND_FILE', '/media/mass/scripts/twin/sleep.wav')
